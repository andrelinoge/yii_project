                            ...
                            <? $cells = $record->{$rowCellsGetterMethod}(); ?>
                                <tr id="<?= $widgetFormId ?>_record_<?= $record->{$primary}; ?>" class="odd" >
                                    ...
                                    <td style="text-align: center;">
                                        ...
                                        <a href = "<?= $this->getController()->createUrl( 'testimonials', array( 'objectId' => $record->{$primary} ) ); ?>"
                                           title="<?= _( 'Testimonials' ); ?>"
                                           class="btn btn-small tipb">
                                            <span class="isw-chats"></span> <?// testimonials ?>
                                        </a>

                                        <a href = "<?= $this->getController()->createUrl( 'imageGallery', array( 'objectId' => $record->{$primary} ) ); ?>"
                                           title="<?= _( 'Photo gallery' ); ?>"
                                           class="btn btn-small tipb">
                                            <span class="isw-picture"></span> <?// photo gallery ?>
                                        </a>

                                        <a href = "<?= $this->getController()->createUrl( 'videoGallery', array( 'objectId' => $record->{$primary} ) ); ?>"
                                           title="<?= _( 'Video gallery' ); ?>"
                                           class="btn btn-small tipb">
                                            <span class="icon-white icon-film"></span> <?// video gallery ?>
                                        </a>

                                        <a href = "<?= $this->getViewActionURL( array( 'id' => $record->{$primary} ) ); ?>"
                                           title="<?= _( 'Preview' ); ?>"
                                           class="btn btn-small tipb">
                                            <span class="icon-white  icon-eye-open"></span> <?// preview ?>
                                        </a>

                                        <a href = "<?= $url = $this->getEditActionURL( array( 'id' => $record->{$primary} ) ); ?>"
                                           title="<?= _( 'Edit' ); ?>"
                                           class="btn btn-small tipb">
                                            <span class="isw-edit"></span> <?// edit ?>
                                        </a>
