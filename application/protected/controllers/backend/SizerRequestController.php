...
class SizerRequestController extends BackendController
{
    ...
    {
        return SizerRequest::model()->findByPk($id);
    }

    public function get_collection_provider()
    {
        return SizerRequest::model()->search();
    }

    public function get_read_messages()
    {
        return SizerRequest::model()->search_read();
    }

    public function get_unread_messages()
    {
        return SizerRequest::model()->search_unread();
    }
